...
routes.post('/api/todo/add', auth, async (req, res) => {
...
routes.post('/api/todo/list', auth, async (req, res) => {
  try {
...
routes.patch('/api/todo/update', auth, async (req, res) => {
...
routes.delete('/api/todo/delete', auth, async (req, res) => {
  try {
